<script>
    ...
    function handleAvatarUpload() {
      ...
      setTimeout(() => {
        // Set a demo avatar URL
        profileConfig.avatar = '/api/placeholder/128/128';
          ...
          <div class="mb-4 flex flex-col items-center">
            <div class="w-32 h-32 bg-neutral-200 dark:bg-neutral-700 rounded-lg overflow-hidden flex items-center justify-center relative">
              {#if profileConfig.avatar}
                <img src={profileConfig.avatar} alt="Profile Avatar" class="w-full h-full object-cover" />
              {:else}
            ...
            <div class="mt-4 flex space-x-2">
              ...
              {#if profileConfig.avatar}
                <button 
                  class="py-1.5 px-3 border border-neutral-300 dark:border-neutral-600 text-neutral-700 dark:text-neutral-300 rounded-md hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-colors text-sm"
