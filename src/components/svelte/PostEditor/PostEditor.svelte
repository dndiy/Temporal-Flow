...
<style>
  /* For markdown preview - use existing Tailwind classes */
  :global(.markdown-content h1) {
    @apply text-2xl font-bold mb-4 text-black/90 dark:text-white/90;
  }
  
  :global(.markdown-content h2) {
    @apply text-xl font-bold mb-3 text-black/90 dark:text-white/90;
  }
  
  :global(.markdown-content h3) {
    @apply text-lg font-bold mb-2 text-black/90 dark:text-white/90;
  }
  
  :global(.markdown-content p) {
    @apply mb-4 text-black/75 dark:text-white/75;
  }
  
  :global(.markdown-content ul), :global(.markdown-content ol) {
    @apply mb-4 pl-6 text-black/75 dark:text-white/75;
  }
  ...
  :global(.markdown-content code) {
    @apply font-mono bg-neutral-100 dark:bg-neutral-700 px-1 py-0.5 rounded text-black/75 dark:text-white/75;
  }
  
  :global(.markdown-content pre) {
    @apply bg-neutral-100 dark:bg-neutral-800 p-3 rounded overflow-x-auto mb-4;
  }
  
  :global(.markdown-content blockquote) {
    @apply border-l-4 border-neutral-300 dark:border-neutral-600 pl-4 italic mb-4 text-black/75 dark:text-white/75;
  }
