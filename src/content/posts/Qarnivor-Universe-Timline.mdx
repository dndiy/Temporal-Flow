...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
  ...
  <div className="card-base p-4">
    ...
    <p className="text-sm text-gray-700 dark:text-neutral-300">Marked by the emergence of the first technological singularities and the Digital Awakening, when consciousness began to manifest in unexpected forms across Earth's information networks.</p>
  </div>
